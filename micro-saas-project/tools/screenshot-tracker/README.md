...
```bash
# Clone and setup
git clone https://github.com/yourusername/screenshot-tracker.git
cd screenshot-tracker
...
# Setup database
createdb screenshot_tracker

# Configure environment
export DATABASE_URL="postgresql://user:password@localhost/screenshot_tracker"
...
- **Email**: support@screenshottracker.com
- **Status**: status.screenshottracker.com
...
Made with ❤️ for Marketing & SEO professionals
