...
# Setup database
createdb review_intelligence

# Configure environment
export DATABASE_URL="postgresql://user:password@localhost/review_intelligence"
...
- **Email**: support@reviewintelligence.com
- **Status**: status.reviewintelligence.com

## 📈 Market Size

200M+ local businesses
...
Made with ❤️ for Local Business & Marketing professionals
