...
Version control and testing for AI prompts
...
# Setup database
createdb ai_prompt_manager

# Configure environment
export DATABASE_URL="postgresql://user:password@localhost/ai_prompt_manager"
...
- **Email**: support@aipromptmanager.com
- **Status**: status.aipromptmanager.com
...
Made with ❤️ for AI & Machine Learning professionals
